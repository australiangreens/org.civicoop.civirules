...
function _civirules_civix_class_loader($class) {
  ...
  if (strpos($class, 'CiviMix\\Schema\\Civirules\\') === 0) {
 ...
 */
function _civirules_civix_civicrm_enable(): void {
  _civirules_civix_civicrm_config();
  // Based on <compatibility>, this does not currently require mixin/polyfill.php.
}
