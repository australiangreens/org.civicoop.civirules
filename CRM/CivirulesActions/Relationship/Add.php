...
class CRM_CivirulesActions_Relationship_Add extends CRM_CivirulesActions_Generic_Api
{
  ...
  protected function alterApiParameters($parameters, CRM_Civirules_TriggerData_TriggerData $triggerData)
  {
    ...
    if ($parameters['reverse_relationship']) {
      $temp =  $parameters['contact_id_a'];
      $parameters['contact_id_a'] =  $parameters['contact_id_b'];
      $parameters['contact_id_b'] = $temp;
    }
  ...
  public function userFriendlyConditionParams()
  {
    ...
    $label_type = $params['reverse_relationship'] ? 'label_b_a' : 'label_a_b';
