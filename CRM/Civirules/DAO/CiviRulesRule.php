 ...
 * (GenCodeChecksum:f0f3407b10787ed010b8873ff585fa21)
 */
...
class CRM_Civirules_DAO_CiviRulesRule extends CRM_Core_DAO {
  ...
  public static function getReferenceColumns() {
    if (!isset(Civi::$statics[__CLASS__]['links'])) {
      ...
      Civi::$statics[__CLASS__]['links'][] = new CRM_Core_Reference_Basic(self::getTableName(), 'created_user_id', 'civicrm_contact', 'id');
      Civi::$statics[__CLASS__]['links'][] = new CRM_Core_Reference_Basic(self::getTableName(), 'modified_user_id', 'civicrm_contact', 'id');
